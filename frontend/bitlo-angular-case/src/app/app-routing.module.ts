...
const routes: Routes = [
  ...
  { path: 'profil', component: ProfileComponent, canActivate: [] },
  { path: 'profil/bakiyeler', component: BalanceComponent, canActivate: [] },
  { path: 'profil/acik-emirler', component: OpentransactionsComponent, canActivate: [] },
